...
namespace CompilerPlugin
{
    ...
    public class Compiler : ICompilerPlugin
    {
        ...
        public string CompilerPluginLanguageName => "php";
        public string CompilerPluginLanguageExt => "php";
        public string CompilerPluginDisplayName => "SimplePM PHP compiler module";
        ...
        public bool SetRunningMethod(ref IniData sConfig, ref IniData sCompilersConfig, ref ProcessStartInfo startInfo, string filePath)
        {
            try
            {
                ...
                startInfo.FileName = sCompilersConfig["PHP"]["Path"];
